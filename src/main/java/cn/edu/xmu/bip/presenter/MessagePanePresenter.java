...
public class MessagePanePresenter implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        vbMessage.setSpacing(paneMargin);
        vbMessage.setPadding(new Insets(paneMargin));

        double imageWidth = MeasurementUtil.getNodeSizeInParentByFactor(paneWidth, IMAGE_WIDTH_FACTOR);
