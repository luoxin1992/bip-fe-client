...
CREATE TABLE IF NOT EXISTS tbl_resource(id INTEGER PRIMARY KEY AUTOINCREMENT, type TEXT NOT NULL, url TEXT NOT NULL, path TEXT NOT NULL, filename TEXT NOT NULL, md5 TEXT NOT NULL, timestamp TEXT NOT NULL, status INTEGER DEFAULT 0 NOT NULL);
